...
describe('ConnectionsComponent', () => {
  let component: MarketGroupComponent;
  let fixture: ComponentFixture<MarketGroupComponent>;
  let http: HttpTestingController;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ MarketGroupComponent ],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(MarketGroupComponent);
